...
class MainActivity : ComponentActivity() {
                ...
                Surface(
                    ...
                    Column {
                        TopAppBar(
                            ...
                            actions = {
                                DarkLightThemeChooser(isDarkTheme)
                            }
                        )
    ...
    @Composable
    private fun DarkLightThemeChooser(isDarkTheme: MutableState<Boolean>) {
        Icon(
            painter = painterResource(id = if (isDarkTheme.value) R.drawable.ic_light_theme else R.drawable.ic_dark_theme),
